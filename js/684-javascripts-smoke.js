/*
    --- Credits ---
    Shader from: https://codepen.io/Irehan/pen/YgyozL

    --- Note ---
    This shader was modified to fit in the website, if you want to use it for your own consider using the original.
